...
this.newusername.addActionListener(new ActionListener()
    {
      ...
      {
        changepassuser.this.newpassword.requestFocus();
      }
    });
    ...
    public void effect(){
         String stru = "";
        stru = changepassuser.this.newusername.getText();
        
        String strc = "";
        strc = changepassuser.this.newpassword.getText();
       ...
       try
    {
      ...
      String sql = "UPDATE lib_user SET user_password ='" + this.newpassword.getText() + "'WHERE id='2' ";
      String sql1 = "UPDATE lib_user SET user_name='" + this.newusername.getText() + "'WHERE id='2'  ";
